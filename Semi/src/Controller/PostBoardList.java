...
import DAO.BoardDao;
import DAO.PostBoardDaoImpl;
import DTO.PostDTO;
import Service.Paging;

@SuppressWarnings("serial")
@WebServlet("/manager/postlist.do")
public class PostBoardList extends HttpServlet {
	
	private BoardDao dao = new PostBoardDaoImpl();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// list 페이지 불러오기
		req.getRequestDispatcher("/manager/list/postboard/list.jsp")
			.forward(req, resp);
	}
}
