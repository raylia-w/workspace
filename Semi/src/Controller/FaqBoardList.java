...
import DAO.BoardDao;
import DAO.FaqBoardDaoImpl;
import DTO.PostDTO;
import Service.Paging;

@SuppressWarnings("serial")
@WebServlet("/manager/faqlist.do")
public class FaqBoardList extends HttpServlet {
	
	private BoardDao dao = new FaqBoardDaoImpl();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// list 페이지 불러오기
		req.getRequestDispatcher("/manager/list/faqboard/list.jsp")
			.forward(req, resp);
	}
}
