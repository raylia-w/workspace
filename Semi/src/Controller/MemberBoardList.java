...
import DAO.BoardDao;
import DAO.MemberBoardDaoImpl;
import DTO.Member;
import Service.Paging;

@SuppressWarnings("serial")
@WebServlet("/manager/memberlist.do")
public class MemberBoardList extends HttpServlet {
	
	private BoardDao dao = new MemberBoardDaoImpl();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// list 페이지 불러오기
		req.getRequestDispatcher("/manager/list/memberboard/list.jsp")
			.forward(req, resp);
	}
}
