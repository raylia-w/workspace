...
import DAO.BoardDao;
import DAO.ShopBoardDaoImpl;
import DTO.ShopDTO;
import Service.Paging;

@SuppressWarnings("serial")
@WebServlet("/manager/shoplist.do")
public class ShopBoardList extends HttpServlet {
	
	private BoardDao dao = new ShopBoardDaoImpl();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<ShopDTO> list = null;	// 게시물 리스트
		...
		// list 페이지 불러오기
		req.getRequestDispatcher("/manager/list/shopboard/list.jsp")
			.forward(req, resp);
	}
}
